...
function Home() {
    ...
    useEffect(() => {
        document.getElementById(
            "hero-img"
        ).style.backgroundImage = `linear-gradient(to bottom, rgb(0, 48, 24, 0.7), rgb(0, 0, 0, 1)), url("${heroImage}")`;
        ...
        <>
            <HeroBackground id="hero-img">
                <div className="section-boxed flex-container w-60">
                    <Container>
                        <HeroSubtitle>
                            <span className="mobile-hidden color-w">
                                Drogaria Cabral{" "}
                            </span>
                            📍 Itapira - SP
                        </HeroSubtitle>
                        ...
                        <HeroText className="mb-10">
                            Na Drogaria Cabral, oferecemos uma ampla variedade
                            de medicamentos, produtos de saúde e bem-estar, com
                            atendimento personalizado e profissional.
                        </HeroText>
                        <HeroText className="mb-30" style={{ fontWeight: 800 }}>
                            Precisa de algo? Faça seu pedido online agora e
                            receba em casa!
                        </HeroText>
                        <HeroButton
                            href="https://api.whatsapp.com/send/?phone=5519996925463"
                            target="_blank"
                        >
                            Fazer pedido
                        </HeroButton>
                ...
                <div className="section-boxed-thin flex-container">
                    ...
                    <div className="grid-container-3 w-65 gap-50">
                        <ContainerThin>
                            ...
                            <h3>
                                Compre pelo Whatsapp e <b>receba em casa</b>
                            </h3>
                        </ContainerThin>
                        <ContainerThin>
                            <MdOutlineSupportAgent size={"50px"} />
                            <h3>
                                Atendimento atencioso e <b>humanizado</b>
                            </h3>
                        </ContainerThin>
                        <ContainerThin>
                            <AiOutlineDollar size={"50px"} />
                            <h3>
                                Os <b>melhores preços</b> daqui da região
                            </h3>
                        </ContainerThin>
                    </div>
                </div>
            ...
            <SectionAlternative>
                <div className="section-boxed flex-container">
                    ...
                    />
                    <p className="color-w">
                        Aceitamos PIX, Cartão de Crédito à vista ou parcelado*,
                        Cartão de Débito ou Dinheiro.
                    </p>
                    <HomeButton
                        href="https://api.whatsapp.com/send/?phone=5519996925463"
                        target="_blank"
            ...
            <Section>
                <div className="section-boxed flex-container w-65">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3688.235825136255!2d-46.8237130249269!3d-22.420148079600537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c901fca329596b%3A0xdd5c5cb009fd95ac!2sDrogaria%20Cabral%20%7C%20Farm%C3%A1cia%20Delivery%20em%20Itapira!5e0!3m2!1spt-BR!2sbr!4v1719944150545!5m2!1spt-BR!2sbr"
                        width="100%"
                        height="400"
                        style={{ border: 0 }}
                        allowFullScreen=""
